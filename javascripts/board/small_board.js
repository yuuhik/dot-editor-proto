...
(function($) {
  ...
  Board.small_board = (function() {

    var m_main_board = null;
    var m_canvas = null;
    var m_ctx = null;
    var m_width = 70;
    var m_height = 70;
    ...
    // initialize
    return {
      init: function ( main_board ) {
        if (main_board === undefined) {
          throw 'boardオブジェクトよこせや';
        }
        m_main_board = main_board;
        m_canvas = $('#small-canvas').get(0);
